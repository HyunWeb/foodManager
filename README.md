...
- **나의 역할**:  
    - 프로젝트 **팀장** (일정 조율 및 진행 관리)  
    - **프론트엔드 주요 기능 개발** (레시피 추천, 냉장고 관리, 피드 페이지)  
    - **디자인 설계 및 UI/UX 개선** 
...
## 🙋 담당한 역할
- 프로젝트 **팀장**으로 일정 조율 및 팀원 간 협업을 주도  
- **디자인 설계**: Figma를 활용해 UI/UX 개선, 레이아웃 및 색상 시스템 구축  
- **프론트엔드 개발**  
    - **냉장고 관리 페이지**: Redux를 활용해 상태 관리, 유통기한 알림 기능 구현  
    - **레시피 추천 기능**: Open API를 활용해 냉장고 재료 기반 맞춤 레시피 제공  
    - **피드 페이지**: 사용자 간 레시피 공유 기능 및 이미지 업로드 구현  
- **코드 리뷰 및 리팩토링**: 팀원의 코드 리뷰를 진행하고 유지보수를 고려한 코드 리팩토링 수행  
